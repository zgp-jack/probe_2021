<template>
    <div id="global-uploader">
        ...
        <uploader
            ...
            <uploader-btn id="global-uploader-btn" class='global-uploader-btn' :attrs="attrs" ref="uploadBtn">选择文件</uploader-btn>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                options: {
                    target: 'http://192.168.2.15:8080/api/file/chunkUpload',
                    chunkSize: '2048000',
                    ...
                    checkChunkUploadedByResponse: function (chunk, message) {
						...
						let objMessage = JSON.parse(message);
						return objMessage.data.skipUpload
                    },
					headers: {
...
<style scoped lang="scss">
	...
	.global-uploader-btn,.global-uploader-btn:hover{height: 40px;line-height: 40px;background-color: #66b1ff;color: #fff;padding: 0 15px;cursor: pointer;border: none;outline: none;border-radius: 5px;}
