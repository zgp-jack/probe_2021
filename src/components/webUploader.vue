...
export default {
    ...
    props:{
        ...
        uploadSuffixUrl:{
            type:String,
            default: 'http://192.168.2.15:8080/api/file/'
        },
        options:{
            type:Object,
            default:{
    ...
    methods: {
        ...
        register(){//注册函数
            ...
            /* var fileCheckUrl=uploadSuffixUrl;//检测文件是否存在url
            var checkChunkUrl=uploadSuffixUrl;//检测分片url
            var mergeChunksUrl=uploadSuffixUrl;//合并文件请求地址 */
