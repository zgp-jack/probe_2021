<template>
	<div class="box">
		...
		<div class="loginbox">
			<div class="toptile">
				<p class="loginName">网络性能质量遥测系统</p>
				<!-- <p class="loginNameSub">Network performance management</p> -->
			</div>
			<div class="login-content">
				<div class="name-div">
					<i class="login-icon username-icon"></i>
					<input class="name-input" type="text" v-model="username" @keyup.enter="loginAction" placeholder="用户名" />
				</div>
				<div class="password-div">
					<i class="login-icon password-icon"></i>
					<input class="password-input" type="password" @keyup.enter="loginAction" v-model="password" placeholder="密码" />
				</div>
		...
		<div class="footerBox">© 2020 网络性能质量遥测系统版权所有</div>
	</div>
</template>
...
<style scoped>
	.box {
		...
		width: 100%;
		height: 100%;
		background: url(../assets/loginBg1.jpg) no-repeat center;
